      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            _bottomNavItem(1, Icons.person_add_outlined, Icons.person_add_rounded, "Admission", selectedIndex == 1),
            const SizedBox(width: 60), // Space for FAB
            _bottomNavItem(3, Icons.account_balance_wallet_outlined, Icons.account_balance_wallet_rounded, "Finance", selectedIndex == 3),
            _bottomNavItem(5, Icons.school_outlined, Icons.school_rounded, "Students", selectedIndex == 5),
          ],
        ),
      ),
