...
export default function AdmissionsDashboard() {
  ...
  const quickActions = [
    ...
    { label: "Admission Report", icon: <FileText className="w-5 h-5 text-blue-600" />, bg: "bg-blue-50", link: "/office/reports" },
    { label: "Course Settings", icon: <Settings2 className="w-5 h-5 text-rose-600" />, bg: "bg-rose-50", link: "/office/settings" },
