...
const run = async () => {
    try {
        ...
        const dpharmId = new mongoose.Types.ObjectId('6a44b38f6d2da6aee53d4bb5'); // Diploma in Pharmacy
        ...
        console.log(`Successfully uploaded ${inserted} students for 2025-27 batch.`);
        process.exit(0);
