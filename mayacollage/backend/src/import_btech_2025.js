...
const run = async () => {
    try {
        ...
        const btechCourseId = new mongoose.Types.ObjectId('6a44be747b077d27cbe52d35'); // Bachalor of technology
        const branchId = new mongoose.Types.ObjectId('6a44be3a7b077d27cbe52d16'); // B.tech
        const sessionYear = '2025-29';

        const workbook = xlsx.readFile('C:/Users/kdev7/Downloads/B.Tech 2025-29 C.xlsx');
        ...
        console.log(`Successfully uploaded ${inserted} B.Tech students for 2025-29 batch.`);
        process.exit(0);
